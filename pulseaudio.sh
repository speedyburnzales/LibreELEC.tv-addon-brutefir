...
pactl load-module module-pipe-sink file=/run/pulse/fifo_output sink_name=brutefir_sink format=s16le rate=44100 channels=2
pactl set-default-sink brutefir_sink

# Input from brutefir via FIFO
pactl load-module module-pipe-source file=/run/pulse/fifo_input source_name=brutefir_source format=s16le rate=44100 channels=2
